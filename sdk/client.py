...
class RegulationClient:
    ...
    def __init__(self, base_url: str = "http://localhost:8000", timeout: int = 30):
        ...
        self.session.headers.update({
            ...
            'User-Agent': 'RegulationClient/1.0.0'
        })
    ...
    def retrieve(self, 
                 ...
                 top_k: int = 5,
                 max_chars: int = 1200,
                 include_citation: bool = True) -> RetrievalResponse:
        """
...
def quick_search(query: str, laws: Optional[List[str]] = None, top_k: int = 3) -> List[str]:
    """
