...
class FieldExtractor:
    ...
    def extract_fields(self, text: str) -> Dict[str, Optional[str]]:
        ...
        logger.debug(f"Extracted {sum(1 for v in fields.values() if v)} non-empty fields")
        return fields
    ...
    def _is_section_heading(self, line: str) -> bool:
        ...
        heading_keywords = [
            'title', 'description', 'objective', 'goal', 'scope', 'overview',
            'summary', 'background', 'purpose', 'requirements', 'specifications',
            'implementation', 'testing', 'deployment', 'rollout', 'timeline',
            'risks', 'safety', 'privacy', 'security', 'compliance', 'legal',
            'questions', 'issues', 'assumptions', 'dependencies', 'appendix'
        ]
    ...
    def _extract_field(self, sections: List[Tuple[str, str]], patterns: List[str]) -> Optional[str]:
