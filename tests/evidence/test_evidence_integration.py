...
class TestEvidenceIntegration:
    ...
    def test_tiktok_feature_generator_evidence_logging(self):
        ...
        try:
            from src.compliance.feature_generation.tiktok_feature_generator import TikTokFeatureGenerator
    ...
    def test_compliance_reporter_evidence_logging(self):
        ...
        try:
            ...
            from monitoring.reporting.compliance_reporter import FeatureCompliance
