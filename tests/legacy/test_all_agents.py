...
def test_confidence_validator():
    ...
    try:
        ...
        # Test case
        test_text = "Social media platform requires age verification for users under 18 in Utah"
...
def test_evidence_verifier():
    ...
    try:
        ...
        reasoning_text = "Feature violates Utah age verification requirements for users under 18"
        evidence_spans = [
            {
        ...
        # Verify the case
        result = verifier.verify_case(case_id, reasoning_text, evidence_spans, regulation_references)
...
def test_integrated_workflow():
    ...
    try:
        ...
        verification_result = verifier.verify_case(case_id, reasoning_text, evidence_spans, regulation_references)
