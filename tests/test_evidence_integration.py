...
from evidence_logger import get_evidence_logger, log_compliance_decision
...
class TestEvidenceIntegration:
    ...
    def setup_method(self):
        ...
        import src.evidence_logger
        src.evidence_logger._evidence_logger = None  # Reset global instance
    ...
    def teardown_method(self):
        ...
        # Reset global logger
        import src.evidence_logger
        src.evidence_logger._evidence_logger = None
        # Clean up temp files
    ...
    def test_tiktok_feature_generator_evidence_logging(self):
        ...
        try:
            from compliance.feature_generation.tiktok_feature_generator import TikTokFeatureGenerator
